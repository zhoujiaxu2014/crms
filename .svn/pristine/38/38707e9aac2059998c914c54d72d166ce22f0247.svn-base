...
// var QQMapWX = "../../pages/common/sdk/qqmap-wx-jssdk.js";
...
Component({
  ...
  methods: {
    ...
    detailMt(e) {
      ...
      // this.
      if(e.currentTarget.dataset.mycity==1){
        getApp().globalData.cityNameSearch=detail
      }else{
        getApp().globalData.cityNameSearch=detail.name
      }
